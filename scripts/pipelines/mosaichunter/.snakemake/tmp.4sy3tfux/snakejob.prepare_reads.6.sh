...
--wait-for-files /mnt/data/jeremy/scripts/pipelines/mosaichunter/.snakemake/tmp.4sy3tfux /mnt/data/jeremy/scripts/pipelines/mosaichunter/test/TAC-94_recal.bam --latency-wait 30 \
...
--notemp --no-hooks --nolock --timestamp  --printshellcmds  --force-use-threads  --allowed-rules prepare_reads  && touch "/mnt/data/jeremy/scripts/pipelines/mosaichunter/.snakemake/tmp.4sy3tfux/6.jobfinished" || (touch "/mnt/data/jeremy/scripts/pipelines/mosaichunter/.snakemake/tmp.4sy3tfux/6.jobfailed"; exit 1)
