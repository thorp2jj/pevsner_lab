...
parser = argparse.ArgumentParser(description='Annotate variants that are in exons.')
...
for line in infile:
    ...
    while True:
        ...
        try:
            ...
            print(str(ref_line), file=sys.stderr)
            raise
...
#                                            print(str(adjust) + '\t' + str(offset[i]) + '\t' + str(exon_end[i]))
