...
vaast_converter -n 10 --build hg19 --path $2 $1
...
do
    base=${infile%.gvf}
    /mnt/userdata/don/Scripts/gffsort.pl $infile > ${base}.sorted.gvf
    VAT --build hg19 -f /mnt/userdata/reference/VAAST/refGene_hg19_with_introns.header.sorted.gff3 -a /mnt/userdata/reference/hg19/ucsc.hg19.fasta ${base}.sorted.gvf > ${base}.vat.gvf
