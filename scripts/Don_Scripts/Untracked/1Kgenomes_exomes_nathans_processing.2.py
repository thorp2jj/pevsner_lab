...
print("INFO: Running process_fqs.sh on SRR077449_1.filt.fastq.gz and SRR077449_2.filt.fastq.gz with read group id NA127500 and sample name NA12750", file=sys.stderr)
command_line = 'srun -c 20 /mnt/data/don/Scripts/process_fqs.sh /mnt/data/1KGenomes_Exomes/SRR077449_1.filt.fastq.gz /mnt/data/1KGenomes_Exomes/SRR077449_2.filt.fastq.gz NA127500 NA12750'
...
command_line = 'srun -c 5 /cm/shared/plab/apps/JDK/jdk1.8.0_11/bin/java -Xmx5g -jar /cm/shared/plab/apps/GATK/3.2-2/GenomeAnalysisTK.jar -T IndelRealign\
er -R /mnt/data/reference/hs37d5.fa -targetIntervals Indelrealigner2.intervals --knownAlleles /mnt/data/reference/GATK_b37/Mills_and_1000G_\
gold_standard.indels.b37.vcf --knownAlleles /mnt/data/reference/GATK_b37/1000G_phase1.indels.b37.vcf -I /mnt/data/1KGenomes_Exomes/SRR070516_sorted_mem.bam -o /mnt/data/1KGenomes_Exomes/SRR070516_realigned.bam'
shell_args = shlex.split(command_line)
p = subprocess.Popen(shell_args)
process_bin.append(p)
time.sleep(10)
